          ...
          >
              ...
              <nav className="list-none mb-10">
                <li>
                  <a className="text-gray-600 hover:text-gray-800">
                    UAE Based Language Center Authority
                  </a>
                </li>
                <li>
                  <a className="text-gray-600 hover:text-gray-800">
                ...
                <li>
                  <a className="text-gray-600 hover:text-gray-800">UAE</a>
                </li>
              </nav>
            </div>
            <div className="lg:w-1/4 md:w-1/2 w-full px-4" bis_skin_checked={1}>
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4" bis_skin_checked={1}>
              ...
              >
                ...
                <button className="projectMainButton">SUBSCRIBE</button>
              </div>
              <p className="text-gray-500 text-sm mt-2 md:text-left text-center">
                To get notified about our
        ...
        <div className="bg-gray-100" bis_skin_checked={1}>
          ...
          >
            <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
              ...
              <span className="ml-3 text-xl">Phonetics</span>
            </a>
